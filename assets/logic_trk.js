(function() {
    ...
    support_info['store_name'] = 'byravn.myshopify.com';
    ...
    if (typeof fbq === 'undefined' || typeof fbq === 'function') {
        var myAppJavaScript = function($) {
            ...
            $(document).ready(function() {
                var str = JSON.stringify({"Main Pixel0":"214623445622001"});
                ...
                var getPixelIds = function (productIds, type, content) {
                    $.ajax({
                        ...
                        dataType:'JSON',
                        crossDomain: true,
                        data:{'productIds':productIds,storeName:'byravn.myshopify.com'},
                        type:'POST',
                ...
                function getPurEventSetting(){
				    var response;
              		$.ajax({
                        ...
                        crossDomain: true,
                        async:false,
                        data:{'purchaseEvent':'yes',storeName:'byravn.myshopify.com'},
                        type:'POST',
                        success:function(data) {
                          	response = data;
                        },
                ...
                //----------Start Buy It Now Button - App Version 4.1.9 ----
                ...
                if (location.pathname.match(/\/products\/.+/)) {
                    ...
                    setTimeout(function(){FacebookPixel('track', 'ViewContent', {
                        ...
                        app_ver: 'Pixel Conversion Pro v4.1.9',
